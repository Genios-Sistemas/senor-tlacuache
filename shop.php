<?php
	...
	$url = "https://app.stelorder.com/app/products?APIKEY=IPfuxZDmB0HP1n4PbV9VaYFZNjAdO78Y7AUDlT44";
			...
			<div class="row">
				<div class="col-lg-12 col-sm-12 text-center">
					<div class="main-menu-wrap">
						...
						<nav class="main-menu">
							<ul>
								<li class="current-list-item"><a href="index_2.html">Inicio</a></li>
								<li><a href="shop.html">Tienda</a>
									<ul class="sub-menu">
										<li><a href="shop.html">Tienda</a></li>
										<li><a href="checkout.html">Check Out</a></li>
										<li><a href="single-product.html">Detalles del producto</a></li>
								...
								<li><a href="news.html">Blog</a>
									<ul class="sub-menu">
										...
										<li><a href="single-news.html">Detalles del blog</a></li>
									</ul>
								</li>
								<li><a href="about.html">Nosotros</a></li>
								<li><a href="contact.html">Inspiración de espacios</a></li>
								<li>
				...
				<div class="col-lg-12">
					...
					<div class="search-bar">
						<div class="search-bar-tablecell">
							...
							<button type="submit">Busqueda: <i class="fas fa-search"></i></button>
						</div>
					</div>
				</div>
			</div>
                ...
                <div class="col-md-12">
                    <div class="product-filters">
                        <ul>
                            ...
                            <li data-filter=".bateas">Bateas</li>
                            <li data-filter=".libros">Libros</li>
                            <li data-filter=".tortilleras">Tortilleras</li>
							<li data-filter=".picaportes">Picaportes</li>
                            <li data-filter=".moldes">Moldes</li>
